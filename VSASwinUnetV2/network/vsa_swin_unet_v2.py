...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, token="window", layer_scale = 1e-5):
        super().__init__()
        self.dim = dim
        ...
        if self.token == "VSA":
          # Borrow from VSA
          self.pos = nn.Conv2d(dim, dim, self.window_size//2*2+1, 1, self.window_size//2, groups=dim, bias=True)
